...
class Calculator {
    ...
    constructor(){
        ...
        this._numbers.addEventListener("click", function(e) {
            ...
            if (!btn) return;
            if (btn.classList.contains("btn-dot") && that._displayInputSec.textContent.includes(".")) ;
            else that._showNumber(btn);
        });
        ...
        this._delete.addEventListener("click", function() {
            that._displayInputSec.textContent = that._displayInputSec.textContent.slice(0, -1);
        });
...
},{}]},["9kCas","CE27q"], "CE27q", "parcelRequireff1f")
